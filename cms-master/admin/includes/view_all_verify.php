...
if(isset($_GET['approve'])){
  $id = $_GET['approve'];
  $query = "INSERT INTO checkouts(equipmentID, studentID, workerID, timeOut)";
  $query .= "VALUES('{$equipmentID}', '{$studentID}', '{$_SESSION['username']}', '{$timeout}')";
  $approve_student_query = mysqli_query($connection, $query);
