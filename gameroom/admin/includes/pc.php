<!-- This file is for making a report on the PCs.-->
  ...
  if(isset($_POST['submitPC'])){
    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <?php
        $query = "SELECT * FROM equipment RIGHT JOIN checkouts ON equipment.equipmentID = checkouts.equipmentID WHERE equipmentTypeID = 5";
