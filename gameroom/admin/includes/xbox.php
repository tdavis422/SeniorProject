<!-- This file is for making a report on the Xboxes.-->
  ...
  if(isset($_POST['submitXbox'])){
    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <?php
        $query = "SELECT * FROM equipment RIGHT JOIN checkouts ON equipment.equipmentID = checkouts.equipmentID WHERE equipmentTypeID = 4";
