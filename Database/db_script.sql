...
-- Table: checkouts
CREATE TABLE checkouts (checkoutsID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 
...
-- Table: equipment
CREATE TABLE equipment (equipmentID INTEGER PRIMARY KEY ASC, 
...
CREATE TABLE equipmentTypes (equipmentTypeID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 
	equipmentType STRING (255) NOT NULL);

-- Table: workers
CREATE TABLE workers (workerID PRIMARY KEY ASC NOT NULL, 
